...
var routes = [
    ...
    { path: 'detail/:dername', component: _product_details_product_details_component__WEBPACK_IMPORTED_MODULE_3__["ProductDetailsComponent"] },
...
/* harmony import */ var _small_cart_small_cart_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./small-cart/small-cart.component */ "./src/app/small-cart/small-cart.component.ts");
/* harmony import */ var _big_cart_big_cart_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./big-cart/big-cart.component */ "./src/app/big-cart/big-cart.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _small_cart_small_cart_component__WEBPACK_IMPORTED_MODULE_11__["SmallCartComponent"],
                _big_cart_big_cart_component__WEBPACK_IMPORTED_MODULE_12__["BigCartComponent"]
            ],
            imports: [
...
/***/ "./src/app/big-cart/big-cart.component.css":
/*!*************************************************!*\
  !*** ./src/app/big-cart/big-cart.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/big-cart/big-cart.component.html":
/*!**************************************************!*\
  !*** ./src/app/big-cart/big-cart.component.html ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/app/big-cart/big-cart.component.ts":
/*!************************************************!*\
  !*** ./src/app/big-cart/big-cart.component.ts ***!
  \************************************************/
/*! exports provided: BigCartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BigCartComponent", function() { return BigCartComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var BigCartComponent = /** @class */ (function () {
    function BigCartComponent() {
    }
    ...
    BigCartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./big-cart.component.html */ "./src/app/big-cart/big-cart.component.html"),
            styles: [__webpack_require__(/*! ./big-cart.component.css */ "./src/app/big-cart/big-cart.component.css")]
        }),
...
/* harmony import */ var _cartItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cartItem */ "./src/app/cartItem.ts");
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.getCart = function () {
        ...
        this.http.get(this.cartUrl)
            ...
            return _this.cart = cartItem;
        });
    };
    CartService.prototype.addCartItem = function (item) {
        return this.http.post(this.cartUrl, _cartItem__WEBPACK_IMPORTED_MODULE_2__["cartItem"], httpOptions);
    };
...
module.exports = "<h2>\n\tBuy yourself a phobia!  <br/>  <br/> \n\tWhy ? Cause you are premium. Just like our \n\t<a href=\"http://localhost:8080/produkte\">products</a>\n</h2>\n<p>\n\tDid you ever feel like \"meh\" ? <br/>   \n\tNo?  <br/> Thats good, we dont either. We are premium people and our \n\t<a href=\"http://localhost:8080/produkte\">products</a> are for premium customers ONLY.  \n\t<br/> BuyPhobia is the answer to the question you never asked for. \n\t<br/>  We dont sell just regular products. We sell lifestyle.  \n</p>\n"
...
module.exports = "\n  \n    <h2>{{this.productService.detailProduct[0].dername}}</h2>\n\n\n    "
...
var ProductDetailsComponent = /** @class */ (function () {
    ...
    ProductDetailsComponent.prototype.getProduct = function () {
        var dername = this.route.snapshot.paramMap.get('dername');
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getProduct = function (term) {
        var _this = this;
        if (!term.trim()) {
            // if not search term, return empty hero array.
        }
        else {
            this.http.get(this.productsUrl + "/?dername=" + term)
                .subscribe(function (product) { return _this.detailProduct = product; });
        }
    };
    ...
    ProductService.prototype.updateProduct = function (product) {
        var _this = this;
        return this.http.put(this.productsUrl, product, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("updated product dername=" + product.dername); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateProduct')));
    };
...
module.exports = "\n   \n<h2>My Products</h2>\n<div class=\"prodansi\">\n  <div *ngFor=\"let product of this.productService.product\"\n  routerLink=\"/detail/{{product.dername}}\">\n      <div >\n        <div class=\"part1\"> {{product.dername}} </div>\n        <div class=\"part2\"> {{product.text}} </div>\n        <div class=\"part3\">\n         \n       </div>\t\n       <div > Price:${{product.price}}  / Stock: {{product.stock}}  </div>\n     </div>\n    </div>\n  </div>\n\n\n"
...
/***/ "./src/app/small-cart/small-cart.component.css":
/*!*****************************************************!*\
  !*** ./src/app/small-cart/small-cart.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/small-cart/small-cart.component.html":
/*!******************************************************!*\
  !*** ./src/app/small-cart/small-cart.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = " <h2>My Cart</h2>\n<div class=\"prodansi\">\n\n  <div *ngFor=\"let cart of this.cartService.cart\">\n      <div>\n          <p>test</p>\n          {{cart.dername}}\n          {{cart.preis}}\n          {{cart.anzahl}}\n     </div>\n    </div>\n  </div>"

/***/ }),

/***/ "./src/app/small-cart/small-cart.component.ts":
/*!****************************************************!*\
  !*** ./src/app/small-cart/small-cart.component.ts ***!
  \****************************************************/
...
var SmallCartComponent = /** @class */ (function () {
    function SmallCartComponent(cartService) {
    ...
    SmallCartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./small-cart.component.html */ "./src/app/small-cart/small-cart.component.html"),
            styles: [__webpack_require__(/*! ./small-cart.component.css */ "./src/app/small-cart/small-cart.component.css")]
        }),
...
module.exports = __webpack_require__(/*! C:\Users\Alex\Documents\Andrex\ueb04\client\buyphob\src\main.ts */"./src/main.ts");
