...
function servePage(pathToFile) {
	...
	return new _promise2.default(function (resolve, reject) {
		var html = (0, _compile2.default)(pathToFile, frontmatter);
...
function serveFragment(pathToFile) {
	...
	var frontmatter = (0, _assign2.default)({}, { request: params }, { global: (0, _ressourceUtils.loadGlobalFrontmatter)() }, { page: pageData }, { session: sessionData });
	return new _promise2.default(function (resolve, reject) {
		var html = (0, _compile2.default)(pathToFile, frontmatter, 'templates');
		resolve({ html: html, status: status, validation: noValidation });
	});
}
...
function start(userConfig) {
	...
	app.use(function (req, res) {
		...
		(0, _routes2.default)().then(function (routes) {
			...
			for (var index = 0; index < routes.length; ++index) {
				...
				if (isDefinedRoute && isDefinedMethod) {
					...
					if ((0, _helper.isDefined)(route.page)) {
						var _pathToFile = (0, _ressourceUtils.resolvePage)(calledUrl, route.page, 'pages', '.hbs');
