...
function prepareRoutes() {
	var routeDef = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

	var routeDefinitions = routeDef;

	if (routeDef == null) {
		try {
			routeDefinitions = (0, _ressourceUtils.loadJson)('routes.json');
		} catch (error) {
			throw (0, _customError.JsonParseError)('routes.json', error.message);
		}
	}
	routeDefinitions = routeDefinitions || JSON.parse((0, _stringify2.default)(magicRoutes));
